...
<a href="https://github.com/camaraproject/project-administration/releases/latest" title="Latest Release"><img src="https://img.shields.io/github/release/camaraproject/project-administration?style=plastic"></a>
...
Sandbox API Repository to describe, develop, document, and test the project-administration Service API(s). The repository does not yet belong to a CAMARA Sub Project.
...
Sandbox API Repository to describe, develop, document, and test the project-administration Service API(s) within the Sub Project []().
...
Incubating API Repository to evolve and maintain the definitions and documentation of project-administration Service API(s) within the Sub Project []()
...
* Service API(s) “project-administration” (see APIBacklog.md) 
...
<!-- Pre-releases of this sub project are available in https://github.com/camaraproject/project-administration/releases -->
<!-- The latest public release is available here: https://github.com/camaraproject/project-administration/releases/latest -->
<!-- For changes see [CHANGELOG.md](https://github.com/camaraproject/project-administration/blob/main/CHANGELOG.md) -->
...
* Mailing List
  ...
  * Subscribe / Unsubscribe to the mailing list <https://lists.camaraproject.org/g/sp-adm>.
  * A message to the community of this Sub Project can be sent using <sp-adm@lists.camaraproject.org>.
